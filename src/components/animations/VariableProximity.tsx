...
interface VariableProximityProps extends React.HTMLAttributes<HTMLElement> {
  label?: string;
...
const VariableProximity = forwardRef<HTMLElement, VariableProximityProps>((props, ref) => {
  ...
  const mousePositionRef = useMousePositionRef(containerRef as React.RefObject<HTMLElement | null>);
